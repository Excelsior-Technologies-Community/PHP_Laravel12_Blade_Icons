...
<body class="bg-gray-100 dark:bg-gray-900 flex items-center justify-center min-h-screen transition-colors duration-300">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 w-full max-w-lg transition-colors duration-300">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">➕ Create New Task</h1>
        ...
        <form method="POST" action="/tasks" class="space-y-4">
            ...
            <div>
                ...
                <input name="title" class="w-full border dark:border-gray-600 dark:bg-gray-700 dark:text-white p-3 rounded-lg focus:ring-2 focus:ring-blue-400 outline-none transition-colors"
